...
x = arr.includes(445); console.log(x);
 
// indexOf() - Return the index of the first match
x = arr.indexOf(28); console.log(x);

// Return array as a string
x = arr.toString(); console.log(x);
x = arr.join(); console.log(x);
...
// x = arr.slice(1, 4); console.log(x); // [29, 44, 38]
...
// x = arr.splice(1, 4); console.log(x); // [29, 44, 38, 28]
...
// x = arr.splice(4, 1); console.log(x); // []

// Chaining methods - Some methods can be chained depending on the return value.
x = arr.slice(1, 4); console.log(x);
x = arr.slice(1, 4).reverse(); console.log(x);
x = arr.slice(1, 4).reverse().toString(); console.log(x);
x = arr.slice(1, 4).reverse().toString().charAt(0); console.log(x);
